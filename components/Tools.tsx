...
import { ArrowLeft, ArrowRight, FileText, Settings, Wand2 } from 'lucide-react';
    ...
    const tools = [
        {
            ...
            description: 'Pesquisa semantica avancada com IA para catalogos do Governo (CATMAT/CATSER).',
        ...
        },
        {
            ...
            description: 'Automacao via IA para rascunho de Documentos de Formalizacao da Demanda.',
            icon: <Wand2 size={22} />,
            route: '/dfd',
            accent: 'bg-indigo-600'
        },
        {
            title: 'Criador de Mapa de Precos',
            description: 'Elaboracao e calculo de mapa de precos para os processos.',
            icon: <FileText size={22} />,
            route: '/mapa-precos',
            accent: 'bg-orange-600'
        },
        {
            title: 'Extrator SIPAC',
            description: 'Consulta direta e extracao de dados do processo eletronico no SIPAC.',
            icon: <FileText size={22} />,
            route: '/extrator-sipac',
            accent: 'bg-teal-600'
        }
    ];
            ...
            <main className="max-w-7xl mx-auto px-4 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    >
                        ...
                        <p className="text-[10px] font-black text-slate-300 uppercase tracking-widest text-center px-4">Novos utilitarios em desenvolvimento</p>
                    </motion.div>
                </div>
            </main>
        </div>
